...
FarhadmarketOrderBookTrackingDictionary = Dict[Decimal, Dict[str, Dict[str, any]]]

cdef class FarhadmarketActiveOrderTracker:
    def __init__(self,
                 active_asks: FarhadmarketOrderBookTrackingDictionary = None,
                 active_bids: FarhadmarketOrderBookTrackingDictionary = None):
        super().__init__()
    ...
    @property
    def active_asks(self) -> FarhadmarketOrderBookTrackingDictionary:
        return self._active_asks

    @property
    def active_bids(self) -> FarhadmarketOrderBookTrackingDictionary:
