...
from hummingbot.connector.exchange.farhadmarket.farhadmarket_utils import RequestId
...
class FarhadmarketWebsocket(RequestId):
    ...
    def __init__(self, auth: Optional[FarhadmarketAuth] = None):
        self._auth: Optional[FarhadmarketAuth] = auth
