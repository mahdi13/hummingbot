...
class FarhadmarketOrderBookMessage(OrderBookMessage):
    def __new__(
            cls,
        ...
        return super(FarhadmarketOrderBookMessage, cls).__new__(
    ...
    def asks(self) -> List[OrderBookRow]:
        asks = map(self.content["asks"], lambda ask: [ask["price"], ask["amount"]])
    ...
    def bids(self) -> List[OrderBookRow]:
        bids = map(self.content["bids"], lambda bid: [bid["price"], bid["amount"]])
